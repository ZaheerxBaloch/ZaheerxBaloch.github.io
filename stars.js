// Cosmic background and nebula
const STAR_COLORS = ['#fff', '#19f9ff', '#ff2fd6', '#ffd700', '#bafff2', '#ffe3bb'];
const NUM_STARS = 120;
const SATELLITE_SVGS = [
  `<svg width="40" height="24" viewBox="0 0 40 24" fill="none"><ellipse cx="20" cy="12" rx="13" ry="6" fill="#19f9ff" opacity="0.18"/><rect x="18" y="6" width="4" height="12" fill="#fff"/><rect x="9" y="11" width="6" height="2" fill="#ffd700"/><rect x="25" y="11" width="6" height="2" fill="#ff2fd6"/></svg>`
];
const PLANET_SVGS = [
  `<svg width="48" height="48" viewBox="0 0 48 48" fill="none"><circle cx="24" cy="24" r="18" fill="#ff2fd6" opacity="0.25"/><ellipse cx="24" cy="28" rx="10" ry="4" fill="#19f9ff" opacity="0.11"/><circle cx="24" cy="24" r="12" fill="#ffd700" opacity="0.23"/><ellipse cx="26" cy="26" rx="8" ry="3" fill="#ffe3bb" opacity="0.17"/></svg>`
];
